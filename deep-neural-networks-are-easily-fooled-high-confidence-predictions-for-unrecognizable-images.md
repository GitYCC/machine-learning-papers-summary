...
description: >-
  ...
  unrecognizable images (2015), A. Nguyen et al.
---
...
{% embed url="https://youtu.be/M2IebCN9Ht4" %}
...
![cite from: https://towardsdatascience.com/introduction-to-evolutionary-algorithms-a8594b484ac ](.gitbook/assets/image.png)
...
![showing that CPPN-encoded evolution can produce images that humans and DNNs can recognize](.gitbook/assets/screenshot.png)
